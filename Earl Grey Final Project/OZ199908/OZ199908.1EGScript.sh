#!/bin/bash
#SBATCH -J OZ199908.1EG         				
#SBATCH -o OZ199908.1EG.o%j
#SBATCH -e OZ199908.1EG.e%j       		
#SBATCH -p RM          								
#SBATCH -N 1               								
#SBATCH -n 128              					
#SBATCH -t 48:00:00        						
...
singularity exec earlgrey.sif earlGrey -g OZ199908.1.fasta -s C_ornata_OZ199908 -o ./OZ199908.1_Outputs -t 128